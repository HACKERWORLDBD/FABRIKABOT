...
def print_welcome_message():
    ...
    ascii_art = pyfiglet.figlet_format("HACKER WORLD", font="small")
    ascii_art1 = pyfiglet.figlet_format("BD", font="small")
    print(Fore.CYAN + ascii_art + Style.RESET_ALL)
    print(Fore.CYAN + ascii_art1 + Style.RESET_ALL)
    print(Fore.YELLOW + "https://t.me/HACKER_WORLD_BD")
    print(Fore.CYAN + Style.BRIGHT + "●▬▬▬▬▬๑۩ FABRIKA BOT SCRIPT BY HWBD۩๑▬▬▬▬▬●")
